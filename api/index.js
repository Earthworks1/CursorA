// api/index.js - Point d'entrée unique pour toutes les fonctions API
...
log('Initialisation du serveur API pour Vercel via le point d\'entrée unique');
...
// Handler pour toutes les requêtes API
