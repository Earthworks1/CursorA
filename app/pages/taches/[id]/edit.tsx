...
const EditTachePage: React.FC<EditTacheProps> = ({ id }) => {
  ...
  useEffect(() => {
    if (tache) {
      ...
      const dateDebut = 'dateDebut' in tache && tache.dateDebut ? new Date(tache.dateDebut) : undefined;
      const dateDemande = 'dateDemande' in tache && tache.dateDemande ? new Date((tache as any).dateDemande) : undefined;
      const dateRealisation = 'dateRealisation' in tache && tache.dateRealisation ? new Date((tache as any).dateRealisation) : undefined;
      const dateLimite = 'dateLimite' in tache && tache.dateLimite ? new Date((tache as any).dateLimite) : undefined;
      ...
      form.reset({
        ...
        dateRealisation,
        dateLimite,
        progression: (tache as any).progression || 0,
      });
    }
  }, [tache]);
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={TypeTache.RECOLEMENT}>Recollement</SelectItem>
