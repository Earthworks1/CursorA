...
const EditRessource: React.FC<EditRessourceProps> = ({ id }) => {
    ...
    if (ressource) {
      ...
      if (ressource.caracteristiques) {
        if (ressource.caracteristiques.marque) {
          form.setValue('caracteristiques.marque', ressource.caracteristiques.marque);
        }
        if (ressource.caracteristiques.modele) {
          form.setValue('caracteristiques.modele', ressource.caracteristiques.modele);
        }
        if (ressource.caracteristiques.annee) {
          form.setValue('caracteristiques.annee', ressource.caracteristiques.annee.toString());
        }
        if (ressource.type === 'vehicule' && ressource.caracteristiques.immatriculation) {
          form.setValue('caracteristiques.immatriculation', ressource.caracteristiques.immatriculation);
        }
      }
    }
  }, [ressource, form]);
  ...
  const mutation = useMutation({
    mutationFn: (values: FormValues) => {
      return apiRequest('PUT', `/api/ressources/${id}`, values);
    },
    onSuccess: () => {
