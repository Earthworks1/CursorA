...
export default function PlanningPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {tab === 'heatmap' && <div className="bg-white rounded-lg shadow p-4"><Heatmap tasks={tasks} startDate={new Date()} endDate={new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)} onCellClick={handleHeatmapCellClick} /></div>}
    </div>
  );
} 